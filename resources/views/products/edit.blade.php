...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-warning">Produtos - Alterar</h1>
                ...
                <form action="{{route('products.update', $product->id)}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" class="form-control" name="produto" value="{{$product->produto}}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="">Preço Compra* </label>
                            <input required type="text" class="form-control dinheiro" name="preco_compra" value="{{$product->preco_compra}}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="">Preço Venda* </label>
                            <input required type="text" class="form-control dinheiro" name="preco_venda" value="{{$product->preco_venda}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input required type="text" class="form-control" name="codigo" value="{{$product->codigo}}">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="date" class="form-control" name="validade" value="{{$product->validade}}">
                        </div>
                    </div>

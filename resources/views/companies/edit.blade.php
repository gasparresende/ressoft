...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-primary">Empresas - Alterar</h1>
                ...
                <form action="{{route('companies.update', $company->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input required autofocus type="text" class="form-control" name="nome"
                                   value="{{$company->nome}}">
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="telemovel" value="{{$company->telemovel}}">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="">Logotipo </label>
                            <input type="file" class="form-control" name="logotipo" value="{{$company->logotipo}}">
                        </div>
